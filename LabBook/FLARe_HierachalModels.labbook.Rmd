...
```{r}
flare_data<-list(ntrials=ntrials,nsub=nsub,includeTrial = rep(1,ntrials), screamPlus=screamPlus,screamMinus=screamMinus,
                 ratingPlus=plus,ratingMinus=minus)
...
```{bash}
ssh -t -t -R 80 k1506745@login.rosalind.kcl.ac.uk
```
