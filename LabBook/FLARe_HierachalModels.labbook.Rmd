...
print(paste0("Estimated",(dim(summary$summary)[1]-1) / 342,"Free paramaters per person",sep=" "))
print(" ")
print('Average Rhat')
...
```{r}
# 
# mod_comp <- rbind(mod_comp,c("Mode 1 beta",mean(FLARe_bic)))
# 
...
save(flare_fit, file=file.path(datadir,'flare_fit_2betaMean'))
...
mod_comp <- rbind(mod_comp,c("Mode 2 beta",mean(FLARe_bic)))
