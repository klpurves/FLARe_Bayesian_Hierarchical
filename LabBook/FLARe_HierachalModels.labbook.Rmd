...
FLARe_bic_best<-bic(ntrials,-colMeans(flare_loglike_best),2) #number of parameters in that model e.g. 4)
...
beta <- data.frame(params$summary[343:685])
...
print("real ratings with estimated ratings: CS MINUS")
diag(corr.test(rowMeans(rating_est_minus),rowMeans(minus_scaled))$r)
