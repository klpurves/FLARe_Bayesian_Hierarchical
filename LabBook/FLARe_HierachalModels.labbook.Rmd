...
print(" ")
print('Alpha descriptives')
describe(summary$summary[1:342])
print(" ")

print('Combined beta descriptives')
describe(summary$summary[342:dim(summary$summary)[1]-1])
print(" ")
print('Average Rhat')
mean(summary$summary[,10])
...
$$\alpha = \left(\frac{1-\mu}{\sigma} - \frac{1}{\mu}\right)\mu\left(1-\mu\right)$$
...
## Model 5: reinforcement learning model, mean defined,two beta {.tabset}
