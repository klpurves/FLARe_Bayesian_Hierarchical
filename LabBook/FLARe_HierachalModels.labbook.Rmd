...
## Model 4: RL, mean defined, single beta {.tabset}
...
# extract fit data
summary_flare_me<- summary(flare_fit)
...
## Model 5: RL, mode defined, single beta {.tabset}
...
## Model 6: reinforcement learning model, mean defined,two beta {.tabset}
...
## Model 7: RL mode defined,two beta {.tabset}
...
The alpha parameter variance is still limited (mean 0.09, sd 0.04). Beta is much more bounded now though (combined across both stimuli mean 0.75, sd=1.58) over 2000 iterations.
